...
=======
    ...
    private fun createInfosArray(): ArrayList<Information> {
        ...
        //val questions = arrayListOf<Question>()
        val infos = arrayListOf<Information>()
        infos.add(Information(data_info[0], null, 1))
        infos.add(Information(data_info[1], 1, 2))
        infos.add(Information(data_info[2], 4,3 ))
        infos.add(Information(data_info[4], 3,4))
        infos.add(Information(data_info[5], 3,5))
        infos.add(Information(data_info[6], null,6))
        infos.add(Information(data_info[7], null,7))

        infos.add(Information(data_info[8], 5,8))
        infos.add(Information(data_info[9], 5,9))
        infos.add(Information(data_info[10], 6,10))

        infos.add(Information(data_info[13], 8,11))
        infos.add(Information(data_info[14], 9,12))
        infos.add(Information(data_info[15], null,13))
        infos.add(Information(data_info[19], null,14))
